...
pub mod cisco_ucs_board;
pub mod defencepro;
pub mod dell;
pub mod digipower;
pub mod dlink;
pub mod dlink_dgs1210;
pub mod eaton;
pub mod emc;
pub mod epson;
pub mod fortinet;
...
pub use brocade::BrocadeMib;
pub use brother::BrotherMib;
pub use canon::CanonMib;
pub use cisco::CiscoMib;
pub use cisco_meraki::CiscoMerakiMib;
pub use cisco_ucs_board::CiscoUcsBoardMib;
pub use defencepro::DefenceProMib;
pub use dell::DellMib;
pub use digipower::DigiPowerMib;
pub use dlink::DlinkMib;
pub use dlink_dgs1210::DlinkDgs1210Mib;
...
pub use hp_http_management::HpHttpManagementMib;
...
pub use tplink::TpLinkMib;
pub use ubnt::UbntMib;
pub use voltaire::VoltaireMib;
...
pub fn register_all(registry: &mut MibRegistry) {
    ...
    registry.register(Arc::new(BrocadeMib));
    registry.register(Arc::new(CiscoMerakiMib));
    registry.register(Arc::new(CiscoUcsBoardMib));
    registry.register(Arc::new(DefenceProMib));
    registry.register(Arc::new(DlinkDgs1210Mib));
    registry.register(Arc::new(TpLinkMib));
    registry.register(Arc::new(UbntMib));
    registry.register(Arc::new(VoltaireMib));
    registry.register(Arc::new(HpHttpManagementMib));
}
