...
pub use checkpoint::CheckPointMib;
...
pub use siemens::SiemensMib;
pub use siemens_sicam::SiemensSicamMib;
...
pub use voltronic::VoltronicMib;
pub use watchguard::WatchGuardMib;
pub use wyse_thinos::WyseThinOsMib;
...
pub fn register_all(registry: &mut MibRegistry) {
    ...
    registry.register(Arc::new(AkcpMib));
    registry.register(Arc::new(HwgMib));
    registry.register(Arc::new(MeinbergMib));
    registry.register(Arc::new(UpsMib));
    registry.register(Arc::new(VoltronicMib));
    registry.register(Arc::new(SiemensMib));
    registry.register(Arc::new(SiemensSicamMib));
    registry.register(Arc::new(CheckPointMib));
    registry.register(Arc::new(WyseThinOsMib));
    registry.register(Arc::new(IdracMib));
    registry.register(Arc::new(IloMib));
}
