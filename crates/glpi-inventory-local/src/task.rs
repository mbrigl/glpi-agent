...
use crate::categories::{
    battery, cpu, environment, hardware, memory, network, os, pci, printer, process, software,
    sound, storage, usb, user, video,
};
