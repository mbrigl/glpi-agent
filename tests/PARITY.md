...
| `t/tasks/inventory/win32/**` | `…/categories/*` (Windows path) | ⬜ | Phase 6b — WMI/registry against captured `.wmi` dumps. |
| `t/tasks/inventory/macos/**` | `…/categories/*` (macOS path) | ⬜ | Phase 6c — `system_profiler`/`ioreg`. |
